...
function usage() {
  return [
    ...
    "  --requiredWorkspacePrefix <p> Require workspace id prefix, e.g. smoke-nightly",
    "  --requiredTargetPrefix <p>    Require target id prefix, e.g. smoke-nightly",
    ...
    "  --toolName <name>             Defaults to package_search",
